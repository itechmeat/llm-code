...
- Vite `8.0.15` bumps Rolldown to `1.0.3` (`8.0.14` shipped `1.0.2`); re-check any workaround that targeted pre-`1.0.3` Rolldown quirks before keeping it in build guidance.
